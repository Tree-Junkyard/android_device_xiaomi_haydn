...
git clone https://github.com/Astridxx/android_device_xiaomi_sm8350-common -b crDroid-13 device/xiaomi/sm8350-common
...
echo 'Setting combined qs header in status bar to false'
cd frameworks/base
wget https://github.com/garry-rogov/android_frameworks_base/commit/f7935b46c9d5bb8c563574622762557b62ba3bdc.patch
patch -p1 <f7935b46c9d5bb8c563574622762557b62ba3bdc.patch
cd ../..
